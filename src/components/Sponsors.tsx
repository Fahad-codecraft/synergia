...
const Sponsors = () => {
  ...
  return (
    <div id="sponsors" className="min-h-screen bg-black py-20">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
          {sponsors.map((sponsor, index) => (
            <div
              key={index}
              className="group bg-gradient-to-br from-gray-900 to-black p-6 rounded-xl border border-gray-800 hover:border-red-500 transition-all duration-300"
            >
              ...
              <p className="text-sm text-red-500">{sponsor.type}</p>
            </div>
          ))}
        </div>
      </div>
