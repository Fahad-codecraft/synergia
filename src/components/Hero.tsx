    ...
    <div className="relative h-screen flex items-center justify-center overflow-hidden px-4">
      ...
      <div className="relative z-10 text-center">
        <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold mb-4 sm:mb-6 animate-glow">
          <span className="text-transparent font-[AlphaCorsa] bg-clip-text bg-gradient-to-r from-purple-400 to-red-600">
            SYNERGIA
          </span>
        </h1>
        <p className="text-lg sm:text-xl mb-8 text-gray-300 font-[AlphaCorsa]">Where Events Meets Motorsports</p>
         <div className="flex gap-4 sm:gap-6 justify-center mb-8 sm:mb-12 font-[AlphaCorsa]">
